...
///opt/nfs/jenkinsdata/ 是在jenkins中设置的主目录所以下载的所有文件都会放到/opt/nfs/jenkinsdata/workspace/ ，该目录会自动由jenkins挂载到docker
            ...
            steps {
                script {
                    checkout scmGit(branches: [[name: "${params.appBranchName}"]], extensions: [], userRemoteConfigs: [[credentialsId: '9a922e65-7688-4308-8932-30a2672cb697', url: "${params.appRepoUrl}"]])
         ...
         stage('Build application image') {
                ...
                script{
                    ...
                    checkout scmGit(branches: [[name: "${params.appDockerFileBranchName}"]], extensions: [], userRemoteConfigs: [[credentialsId: '9a922e65-7688-4308-8932-30a2672cb697', url: "${params.appDockerFileRepoUrl}"]])
         ...
         stage('build trivy image') {
                ...
                steps{
                    script{
                        checkout scmGit(branches: [[name: "${params.trivyBranchName}"]], extensions: [], userRemoteConfigs: [[credentialsId: '9a922e65-7688-4308-8932-30a2672cb697', url: "${params.trivyRepoUrl}"]])
